...
export default function ProductDetailsCarousel({ product }: any) {
  ...
  const imagesLightbox = product.images.map((_image: any) => _image);
            ...
            <Box key={img} sx={{ px: 0.75 }}>
              <Image
                ...
                sx={{
                  ...
                  cursor: 'pointer',
                  ...(currentIndex === index && {
                    border: (theme: any) => `solid 3px ${theme.palette.primary.main}`,
                  }),
                }}
              />
            </Box>
