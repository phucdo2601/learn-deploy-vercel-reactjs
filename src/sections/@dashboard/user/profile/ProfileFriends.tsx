...
export default function ProfileFriends({ friends, findFriends, onFindFriends }: any) {
...
function applyFilter(array: any, query: any) {
  if (query) {
    return array.filter((friend: any) => friend.name.toLowerCase().indexOf(query.toLowerCase()) !== -1);
  }
